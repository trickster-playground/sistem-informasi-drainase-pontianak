...
export default function CreateRawanBanjir({ lines, selectedKecamatan = 'all', kecamatanList, batasKecamatan }: Props) {
  ...
  function onFilterChange(selected: string) {
    ...
    const url = selected !== 'all'
      ? route('admin.rawan-banjir.create') + '?kecamatan=' + encodeURIComponent(selected)
      : route('admin.rawan-banjir.create');
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    router.post('/admin/rawan-banjir/create', payload, {
      onSuccess: () => {
        setDrawType(null);
        setCoordinates(null);
        setName('');
